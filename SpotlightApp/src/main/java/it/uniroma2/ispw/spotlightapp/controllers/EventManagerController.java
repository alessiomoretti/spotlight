...
public class EventManagerController {
    ...
    private void openNewReservationScene() {
        ...
        try {
            ...
            // passing the current controller
            it.uniroma2.ispw.spotlightapp.controllers.NewReservationController newEventController = fxmlLoader.<it.uniroma2.ispw.spotlightapp.controllers.NewReservationController>getController();
            newEventController.setEventManagerController(this);
